...
var getEstlMetars = function(req, res, next) {
  datastore.runQuery(estlQuery)
  .then((results) => {
...
var getEstaMetars = function(req, res, next) {
  datastore.runQuery(estaQuery)
  .then((results) => {
  // Task entities found.
  var metars = results[0];
  ...
  var getEsmkMetars = function(req, res, next) {
  datastore.runQuery(esmkQuery)
  .then((results) => {
  // Task entities found.
  var metars = results[0];
  ...
  var getEsmsMetars = function(req, res, next) {
  datastore.runQuery(esmsQuery)
  .then((results) => {
  // Task entities found.
  var metars = results[0];
...
app.use('/skanemetars',getEstlMetars,getEsmkMetars,getEstaMetars,getEsmsMetars, function(req, res, next) {
